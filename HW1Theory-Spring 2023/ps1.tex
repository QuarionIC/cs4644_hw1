...
\item
\textbf{[2 points]}
\input{question-bank/Optimization/levelsets}

\item
\textbf{[2 points]}
\input{question-bank/Optimization/local_min_gradient}

\item
\textbf{[3 points]}
\input{question-bank/Optimization/global_min_convex}

\item
\textbf{[2 points]}
\input{question-bank/Optimization/softmax_gradient}

\item
\textbf{[3 points: Extra credit for both 4644 and 7643]}
\input{question-bank/Optimization/softmax_simplex_projection}

\end{enumerate}

\section{Directed Acyclic Graphs (DAG)}
\input{question-bank/Misc/DAG_background}

\begin{enumerate}[resume]

\item
\textbf{[3 points]}
\input{question-bank/Misc/DAG_topological1}

\item
\textbf{[3 points]}
\input{question-bank/Misc/DAG_topological2}
...
\input{question-bank/Paper_Reviews/NeurIPS_2019_weighted_agnostic}
...
\item
\textbf{[20 points]}
\input{question-bank/Coding/learn_MNIST}
